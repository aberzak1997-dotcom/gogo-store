            ...
            <div className="relative z-10 max-w-[800px] mx-auto w-full px-6 md:px-12 py-20 flex flex-col items-center text-center">
              ...
              <div className="space-y-6 flex flex-col items-center">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
                  <Link to="/products">
                    <Button
                      className="h-10 pl-[10px] pr-[10px] rounded-full text-[11px] font-bold uppercase tracking-widest gap-2 shadow-xl shadow-[#1160CB]/15 transition-all duration-300 hover:scale-105"
